...
# Returns the path for the video thumbnails
# Currently only 3 thumbnails are generated
def get_thumbnails(video):
    name = video['name']    
    return [
        f'https://storage.cloud.google.com/{constants.OUTPUT_BUCKET}/thumbnails/'+name + '_thumbnail_' + str(i)+'.png' for i in range(0, 3)
    ]